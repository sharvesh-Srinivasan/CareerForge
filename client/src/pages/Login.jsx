...
import { login as loginApi, googleLogin as googleLoginApi } from '../api';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <main className="max-w-sm mx-auto pt-12 px-4 pb-20">
        <div className="mb-8">
          <h1 className="text-3xl font-medium mb-2 tracking-tight">Sign in</h1>
          <p className="text-gray-600">to continue to your placement dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-black text-white rounded-md px-4 py-2 text-sm font-medium hover:bg-gray-800 disabled:opacity-50 transition-colors flex justify-center"
          >
